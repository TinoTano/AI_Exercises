...
public class Move : MonoBehaviour {
	...
	void Update () 
	{
        ...
        float orientation_scalar = Mathf.Atan2(mov_velocity.x, mov_velocity.z);
        aim.transform.rotation = Quaternion.AngleAxis(Mathf.Rad2Deg * orientation_scalar, Vector3.up);
